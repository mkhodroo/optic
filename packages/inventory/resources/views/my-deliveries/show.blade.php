...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><i class="bi bi-box2-heart"></i> تحویل‌های من: {{ $receiver->name }}</h4>
    <a href="{{ route('inventory.my-deliveries.index') }}" class="btn btn-secondary">
...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="mb-0">تراز کالاهای تحویل شده به شما</h5>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center">کالایی به شما تحویل داده نشده است.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<div class="row">
    <div class="col-md-6">
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-box-arrow-right"></i> تاریخچه تحویل به شما</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
