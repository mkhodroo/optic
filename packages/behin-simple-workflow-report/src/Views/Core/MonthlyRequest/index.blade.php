...
@section('content')
    <div class="card">
        <form action="{{ route('simpleWorkflowReport.monthly-requests.index') }}" method="GET">
                    ...
                    <tbody>
                        @forelse($rows as $row)
                            ...
                            <tr>
                                ...
                                <td dir="ltr">{{ $row->created_at ? toJalali($row->created_at) : '' }}</td>
                                <td>{{ $row->caseCustomer?->fullname ?? '---' }}</td>
                                <td>{{ $row->repairCategory?->value ?: '---' }}</td>
                                <td>
                                    @php
                                ...
                                <td dir="ltr">{{ $row->repair?->repair_start_date ?? '---' }}</td>
                                <td dir="ltr">{{ $row->repair?->repair_end_date ?? '---' }}</td>
                                <td>{{ $row->repair?->totalRepairDuration() ?? '---' }}</td>
                                <td>{{ number_format($rowIncomes) ?? '' }}</td>
                            </tr>
                        @empty
                            <tr>
